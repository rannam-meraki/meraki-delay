...
<style>
    ...
    * { font-family: 'Cairo', sans-serif !important; }
    ...
    .main-header h1 { color: #e94560 !important; font-size: 2.5rem !important; font-weight: 700 !important; margin: 0 !important; }
    .main-header p { color: #eee !important; font-size: 1.1rem !important; margin: 10px 0 0 0 !important; }
    .stats-card {
        background: linear-gradient(135deg, #1a1a2e, #16213e);
        border-radius: 15px; padding: 20px; text-align: center; border: 1px solid #0f3460;
    }
    .stats-card h3 { color: #e94560 !important; font-size: 2rem !important; margin: 0 !important; }
    .stats-card p { color: #aaa !important; margin: 5px 0 0 0 !important; }
    .stButton > button {
        background: linear-gradient(135deg, #e94560, #c73e54) !important;
        color: white !important; font-size: 1.2rem !important; font-weight: 700 !important;
...
def calc(schedule, att_df):
    ...
    for date, employees in sorted(schedule.items()):
        for emp, sched_time in sorted(employees.items()):
            ...
            if len(rec) == 0:
                results.append({
                    "التاريخ": date.strftime("%d/%m/%Y"),
                    "اليوم": WEEKDAY_AR[date.strftime("%A")],
                    "الشهر": date.strftime("%B %Y"),
                    "الموظف": emp,
                    "وقت_الدوام": fmt12(sched_time),
                    "وقت_البصمة": "---",
                    "الفرق_دقيقة": None,
                    "التأخير": None,
                    "الحالة": "لا توجد بصمة",
